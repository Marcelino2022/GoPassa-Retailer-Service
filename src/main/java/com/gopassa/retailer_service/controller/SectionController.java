...
public class SectionController {
    ...
    @PostMapping
    public ResponseEntity<SectionDTO> create(@RequestBody CreateSectionsDTO createSectionsDTO) {
    ...
    @GetMapping("{id}")
    public ResponseEntity<SectionDTO> findById(@PathVariable String id){
    ...
    @PutMapping("{id}")
    public ResponseEntity<SectionDTO> update(@PathVariable String id, @RequestBody UpdateSectionDTO updateSectionDTO) {
